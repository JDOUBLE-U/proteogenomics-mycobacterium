...
Instructions:
 - Install weblogo3: https://code.google.com/p/weblogo/
...
class WebLogoGenerator(object):
    ...
    def __init__(self, output_folder):
        ...
        self.weblogo_options.resolution = 400
        ...
        self.weblogo_options.stack_aspect_ratio = 7
    ...
    def create_weblogo(self, target_proteins):
        ...
        motif_png = open(
            self.output_folder + target_proteins[target_proteins.rfind("/"):target_proteins.find(".")] + "_weblogo.png",
            'wb+')
