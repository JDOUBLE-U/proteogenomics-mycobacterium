...
# TODO add option for mandatory_M
...
def main(genome):
    ...
    used_platform = sys.platform
    if used_platform == 'win32':
    ...
    os.system(sixpack_command + " -sequence %s"
                                " -sformat1 fasta -snucleotide1 -supper1 -table %i"
                                " -firstorf "
                                " -lastorf "
                                " -outfile %s"
                                " -outseq %s"
                                ...
                                " -verbose"
                                " -mstart"
              % (genome, CODON_TABLE, visual_out, out_file, used_platform, min_protein_len))
