...
(function (h, b, d) {
    ...
    d.Augment({
        ...
        Zoom: function (l, w, v, k, t) {
            ...
            var y = w.appendChild(this.EmExSpan.cloneNode(true));
            var o = y.lastChild.firstChild.offsetHeight / 60;
            ...
            var u = w.offsetWidth, r = w.offsetHeight, x = v.offsetHeight, q = v.offsetWidth;
            if (q === 0) {
                q = v.parentNode.offsetWidth
            }
            w.style.position = v.style.position = "";
            return {Y: -j.getBBox(w).h, mW: q, mH: x, zW: u, zH: r}
        },
        initImg: function (k) {
        },
        ...
        alignBox: function (s, o, q) {
            ...
            b.Insert(s.style, ({right: {left: "", right: this.Em(k)}, center: {left: n, marginLeft: p}})[o])
        },
    ...
    MathJax.Hub.Register.StartupHook("mml Jax Ready", function () {
        ...
        g.mbase.Augment({
            toHTML: function (o) {
                ...
                var n = o.bbox.h, r = o.bbox.d, p = false;
                for (l = 0, k = s.length; l < k; l++) {
                    var q = s[l].HTMLspanElement().bbox;
        ...
        g.mo.Augment({
            toHTML: function (v) {
                ...
                var w = this.CoreParent(), o = (w && w.isa(g.msubsup) && this !== w.data[w.base]), l = (o ? this.HTMLremapChars : null);
                ...
                for (var r = 0, n = this.data.length; r < n; r++) {
                    if (this.data[r]) {
                        this.data[r].toHTML(v, q, this.HTMLremap, l)
                    }
                }
                if (!v.bbox) {
