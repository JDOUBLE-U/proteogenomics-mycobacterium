...
MathJax.Hub.Register.StartupHook("HTML-CSS Jax Ready", function () {
    ...
    a.mbase.Augment({
        HTMLlinebreakPenalty: e, HTMLmultiline: function (n) {
            var o = this;
            ...
            if (h) {
                b.createBlank(line, h, (m !== a.INDENTALIGN.RIGHT));
                line.bbox.w += h;
                line.bbox.rw += h
            }
            if (f.n > 0) {
            ...
            return k
        }, HTMLgetShift: function (j, g, l) {
            if (l === a.INDENTALIGN.CENTER) {
                return 0
            }
            var k = g, h = j.values, i = j.VALUES, f;
            if (j.n === 0) {
                f = k.indentshiftfirst || h.indentshiftfirst || i.indentshiftfirst
            } else {
                if (j.isLast) {
                    f = h.indentshiftlast || i.indentshiftlast
                } else {
                    f = h.indentshift || i.indentshift
                }
            }
            if (f === a.INDENTSHIFT.INDENTSHIFT) {
                f = h.indentshift || i.indentshift
            }
            if (f === "auto" || f === "") {
                f = (j.isTSop ? this.displayIndent : "0")
            }
            return b.length2em(f, 0)
    ...
    a.mmultiscripts.Augment({
        HTMLbetterBreak: function (k, g) {
            if (!this.data[this.base]) {
                return false
            }
            var p = k.index.slice(0), n = k.index.shift(), m, q, l, o = (k.index.length > 0), j = false;
            if (!o) {
                k.W += k.w;
                k.w = 0
            }
            k.scanW = k.W;
            var r = this.HTMLspanElement().bbox, h = this.data[this.base].HTMLspanElement().bbox;
            var f = r.w - h.w;
            k.scanW += r.dx;
            l = k.scanW;
            if (this.data[this.base].HTMLbetterBreak(k, g)) {
                j = true;
    ...
    a.mo.Augment({
        HTMLbetterBreak: function (h, f) {
            ...
            h.W = i;
            h.w = o;
            p.lineleading = b.length2em(p.lineleading, f.VALUES.lineleading);
            p.id = this.spanID;
            return true
        }
    });
