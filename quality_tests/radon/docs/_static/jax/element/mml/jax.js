    ...
    a.mfenced = a.mbase.Subclass({
        ...
        setTeXclass: function (h) {
            ...
            if (f.open !== "") {
                ...
                h = this.data.open.setTeXclass(h)
            }
            if (f.separators !== "") {
            ...
            if (f.close !== "") {
                ...
                h = this.data.close.setTeXclass(h)
            }
