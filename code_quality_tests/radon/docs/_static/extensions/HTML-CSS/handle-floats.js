...
MathJax.Extension["HTML-CSS/handle-floats"] = {version: "2.4.0"};
MathJax.Hub.Config({
    "HTML-CSS": {
        styles: {
            ".MathJax_Display": {
...
MathJax.Hub.Register.StartupHook("HTML-CSS Jax Ready", function () {
    var a = MathJax.OutputJax["HTML-CSS"], b = a.Translate;
    a.Augment({
        Translate: function (c, f) {
            b.call(this, c, f);
            if (c.MathJax.elementJax.HTMLCSS.display) {
                var e = c.nextSibling;
                if (!e || e.className !== "MathJax_MSIE_Separator") {
                    var d = a.Element("span", {className: "MathJax_MSIE_Separator"});
                    c.parentNode.insertBefore(d, e)
                }
            }
        }
    });
